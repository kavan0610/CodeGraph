...
CodeGraph is a code intelligence and retrieval system, not a complete compiler or formal program-verification system. It is based on static parsing.

Thus, CodeGraph answers depend on:

the quality of retrieved code
graph relationships generated by static code analysis
embedding quality
LLM capabilities
available context window

The functionality should therefore be interpreted as a relationship-based analysis, rather than a formal proof that every functionality and behaviour of the codebase has been identified.
